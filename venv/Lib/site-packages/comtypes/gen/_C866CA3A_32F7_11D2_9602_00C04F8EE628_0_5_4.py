...
__all__ = [
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPELexicalForm',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SOTCId',
    'SPRST_INACTIVE', 'SSFMOpenReadWrite', 'DISPID_SRCBookmark',
    'SPSVerb', 'SSTTTextBuffer', 'SpeechVisemeFeature',
    'DISPID_SVESentenceBoundary', 'DISPID_SPPsCount', 'SRCS_Disabled',
    'DISPID_SGRName', 'SDTRule', 'DISPID_SGRSTs_NewEnum',
    'SpeechAudioVolume', 'DISPID_SpeechRecognizer', 'DISPID_SFSOpen',
    'SpeechStreamFileMode', 'SPWF_SRENGINE',
    'DISPID_SpeechRecognizerStatus', 'SDA_One_Trailing_Space',
    'ISpeechRecoContext', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SOTsCount', 'SpeechRuleAttributes',
    'SAFT22kHz16BitStereo', 'SPEI_MAX_TTS',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPACommit',
    'DISPID_SVEVoiceChange', 'SVSFParseAutodetect',
    'SPEI_FALSE_RECOGNITION', 'SpLexicon', 'DISPID_SVVolume',
    'SRCS_Enabled', 'SBOPause', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SRGetFormat', 'DISPID_SVAudioOutput', 'ISequentialStream',
    'SPEI_MIN_TTS', 'SAFTDefault', 'SpeechRegistryUserRoot',
    'DISPID_SpeechLexiconWords', 'DISPID_SRDisplayUI',
    'DISPID_SPRText', 'SGDSActive', 'SRAInterpreter',
    'DISPID_SRRGetXMLResult', 'SP_VISEME_15', 'ISpMMSysAudio',
    'DISPID_SVGetVoices', 'STSF_CommonAppData', 'SPSHT_EMAIL',
    'SPFM_CREATE_ALWAYS', 'ISpeechResourceLoader',
    'SpeechPropertyHighConfidenceThreshold', 'SAFT48kHz8BitStereo',
    'SpeechAudioFormatGUIDText', 'DISPID_SpeechFileStream', 'SVP_7',
    'Speech_Default_Weight', '_ISpeechRecoContextEvents',
    'ISpeechCustomStream', 'SPAS_RUN', 'DISPID_SRGDictationSetState',
    'SpeechPropertyResourceUsage', 'SAFT16kHz8BitStereo',
    'SAFTADPCM_22kHzStereo', 'DISPID_SVEAudioLevel', 'SPEI_RESERVED1',
    'SPCT_SUB_DICTATION', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRCEInterference', 'DISPID_SpeechRecoResult', 'SASRun',
    'eLEXTYPE_RESERVED9', 'DISPID_SPIRetainedSizeBytes',
    'SDTLexicalForm', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SDKEnumKeys', 'DISPID_SpeechRecoResultTimes',
    'SPEI_END_SR_STREAM', 'DISPID_SpeechBaseStream', 'SASClosed',
    'SP_VISEME_13', 'DISPID_SPEAudioSizeBytes', 'DISPID_SABufferInfo',
    'DISPID_SDKDeleteKey', 'eLEXTYPE_PRIVATE9',
    'ISpeechRecognizerStatus', 'ISpeechObjectToken',
    'SPSNotOverriden', 'SVEViseme', 'SAFT48kHz16BitMono',
    'SPCT_SUB_COMMAND', 'SpWaveFormatEx', 'SLTUser',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SMSALineId',
    'SAFT16kHz16BitMono', 'SpInProcRecoContext',
    'DISPID_SpeechPhraseElement', 'SPAR_Medium', 'STSF_LocalAppData',
    'ISpeechGrammarRules', 'DISPID_SpeechObjectTokens',
    'SPGS_EXCLUSIVE', 'SDTAll', 'DISPID_SRRPhraseInfo',
    'DISPID_SLWsItem', 'DISPID_SpeechRecoResult2',
    'DISPID_SpeechCustomStream', 'SpeechEngineProperties',
    'DISPID_SDKSetStringValue', 'SpTextSelectionInformation',
    'ISpeechGrammarRule', 'SVEPhoneme', 'DISPID_SLWPronunciations',
    'SPVISEMES', 'SPPS_RESERVED4', 'SPEI_VOICE_CHANGE',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SpeechPhraseProperty',
    'SPPS_Noncontent', 'SAFT16kHz8BitMono', 'ISpObjectTokenCategory',
    'SAFT32kHz16BitStereo', 'SpeechAudioFormatGUIDWave', 'SVP_14',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SGRSRule', 'SPSFunction',
    'DISPID_SOTRemoveStorageFileName', 'ISpNotifySource',
    'SDTProperty', 'DISPID_SpeechLexiconWord', 'ISpProperties',
    'ISpeechPhraseElements', 'DISPID_SPPFirstElement',
    'SpeechPropertyAdaptationOn', 'SITooSlow', 'SpeechInterference',
    'STCAll', 'DISPID_SPEEngineConfidence', 'ISpeechAudio',
    'SpeechFormatType', 'SAFT48kHz16BitStereo',
    'DISPID_SPAStartElementInResult', 'SREPropertyStringChange',
    'SVEWordBoundary', 'SPCT_SLEEP', 'eLEXTYPE_RESERVED4',
    'eLEXTYPE_PRIVATE16', 'SPPS_RESERVED2', 'SPSHORTCUTPAIR',
    'SpeechRunState', 'SPEI_RESERVED6', 'SRTAutopause',
    'DISPID_SRGCommit', 'SREBookmark', 'SPEI_TTS_BOOKMARK',
    'ISpeechVoice', 'DISPID_SVSVisemeId', 'DISPID_SPAsCount',
    'SP_VISEME_16', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SGRSTNextState', 'ISpResourceManager',
    'DISPID_SRCAudioInInterferenceStatus',
    'SpeechRetainedAudioOptions', 'SpeechCategoryAudioIn',
    'SpeechCategoryAudioOut', 'SPEI_PHRASE_START', 'DISPID_SLWType',
    'DISPID_SVSPhonemeId', 'eLEXTYPE_PRIVATE8', 'DISPID_SVPause',
    'DISPID_SRGCmdSetRuleState', 'STSF_AppData', 'IStream',
    'SREAudioLevel', 'DISPID_SRRTimes', 'SP_VISEME_12',
    'DISPID_SVEStreamStart', 'SSFMCreateForWrite',
    'DISPID_SWFEFormatTag', 'SPSHORTCUTPAIRLIST', 'DISPID_SPCLangId',
    'DISPID_SVSpeakStream', 'DISPID_SPEsItem', 'SPWAVEFORMATTYPE',
    'SPRULESTATE', 'eWORDTYPE_ADDED', 'SpSharedRecoContext',
    'SRAImport', 'SECLowConfidence', 'SpeechCategoryRecognizers',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRCESoundStart', 'SPWF_INPUT',
    'DISPID_SVSpeak', 'SPEVENTENUM', 'STSF_FlagCreate',
    'SpInprocRecognizer', 'DISPID_SRGState',
    'IInternetSecurityMgrSite', 'ISpRecoCategory', 'ISpAudio',
    'SVP_5', 'DISPID_SBSRead', 'DISPID_SOTId',
    'DISPID_SRSCurrentStreamPosition', 'eLEXTYPE_USER',
    'DISPID_SPIGrammarId', 'DISPID_SVStatus', 'SAFT16kHz16BitStereo',
    'DISPID_SPPValue', 'eLEXTYPE_PRIVATE10',
    'SpeechDictationTopicSpelling', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SLPsItem', 'DISPID_SLAddPronunciation',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFTCCITT_ALaw_8kHzMono',
    'SDKLCurrentConfig', 'DISPID_SPCPhoneToId',
    'DISPID_SGRSAddRuleTransition', 'SPPROPERTYINFO',
    'SPWT_PRONUNCIATION', 'SAFT8kHz8BitMono',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpeechLexicon',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVP_4', 'eLEXTYPE_PRIVATE20',
    'SPDKL_CurrentConfig', 'eLEXTYPE_PRIVATE4',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPERequiredConfidence',
    'SPFM_NUM_MODES', 'SPSEMANTICERRORINFO', 'DISPID_SDKDeleteValue',
    'SRARoot', 'SPSInterjection', 'SpeechAudioState',
    'SpeechAudioProperties', 'SRSEIsSpeaking',
    'SDA_Two_Trailing_Spaces', 'DISPID_SpeechMMSysAudio',
    'SpObjectTokenCategory', 'SPFM_OPEN_READWRITE', 'SSFMOpenForRead',
    'DISPID_SPRuleParent', 'SITooLoud', '_SPAUDIOSTATE',
    'ISpRecoGrammar2', 'ISpeechPhraseProperties',
    'SAFTADPCM_8kHzStereo', 'DISPID_SVAudioOutputStream',
    'DISPID_SGRSTWeight', 'SVSFParseSapi',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRRAlternates',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SpeechPhoneConverter',
    'SP_VISEME_17', 'DISPID_SWFEExtraData', 'ISpEventSink',
    'SPXRO_SML', 'SPAR_Unknown', 'DISPID_SpeechAudio',
    'SECFIgnoreKanaType', 'SPAO_NONE', 'SPSMF_UPS',
    'SPPS_Interjection', 'STCRemoteServer', '__MIDL_IWinTypes_0009',
    'SRERecoOtherContext', 'DISPID_SVPriority', 'DISPID_SPRsItem',
    'ISpeechObjectTokens', 'SVSFPurgeBeforeSpeak',
    'ISpeechLexiconPronunciations', 'SPSModifier', 'SP_VISEME_0',
    'DISPID_SOTSetId', 'ISpeechPhraseRules',
    'DISPID_SpeechObjectToken', 'ISpeechTextSelectionInformation',
    'DISPID_SVEBookmark', 'DISPID_SRRecognizer', 'SpAudioFormat',
    'SPEVENTSOURCEINFO', 'SWPKnownWordPronounceable',
    'SpeechTokenShellFolder', 'SGDSInactive',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPRDisplayAttributes',
    'SRERecognition', 'SpeechCategoryRecoProfiles',
    'DISPID_SOTGetStorageFileName', 'SVP_8', 'SRSInactive',
    'SVF_None', 'DISPID_SGRsDynamic', 'ISpRecoContext2',
    'ISpeechAudioFormat', 'SpCompressedLexicon',
    'SAFT11kHz16BitStereo', 'DISPID_SMSADeviceId',
    'SAFTCCITT_ALaw_11kHzStereo', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechPhraseAlternates', 'SpPhoneticAlphabetConverter',
    'SPEI_TTS_PRIVATE', 'SpMMAudioOut',
    'DISPID_SpeechPhraseAlternate', 'LONG_PTR',
    'DISPID_SPPEngineConfidence', 'SAFTGSM610_44kHzMono',
    'DISPID_SVEPhoneme', 'SVSFlagsAsync', 'DISPID_SOTDisplayUI',
    'SP_VISEME_2', 'SpeechGrammarTagWildcard',
    'DISPID_SRCCreateGrammar', 'SVEPrivate', 'DISPID_SPRuleName',
    'SECFIgnoreCase', 'DISPID_SGRId', 'DISPID_SRCEBookmark',
    'SSSPTRelativeToEnd', 'DISPID_SAFGuid', 'SAFTNoAssignedFormat',
    'SWTAdded', 'SPCATEGORYTYPE', 'DISPID_SVRate',
    'ISpeechPhraseRule', 'DISPID_SMSSetData', 'DISPID_SAFType',
    'ISpeechPhraseReplacement', 'DISPIDSPTSI_ActiveLength',
    'SpeechDataKeyLocation', 'Speech_StreamPos_Asap', 'SRAONone',
    'SGLexical', 'DISPID_SRCEventInterests', 'SpeechBookmarkOptions',
    'DISPID_SVEventInterests', 'DISPID_SpeechPhraseRules',
    'DISPID_SLRemovePronunciationByPhoneIds', 'eLEXTYPE_PRIVATE6',
    'DISPID_SVGetAudioOutputs', 'DISPID_SOTDataKey',
    'DISPID_SPANumberOfElementsInResult', 'SRTStandard',
    'DISPID_SPRules_NewEnum', 'SVSFNLPSpeakPunc', 'SVP_15',
    'ISpeechMMSysAudio', 'DISPID_SBSFormat',
    'DISPID_SRGDictationUnload', 'SPEI_VISEME', 'DISPID_SPPChildren',
    'SPPHRASE', 'SPEI_RESERVED5', 'SECFIgnoreWidth',
    'SDKLCurrentUser', 'DISPID_SRIsShared',
    'SpeechSpecialTransitionType', 'IEnumString',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SGRsFindRule',
    'DISPID_SOTCategory', 'SGRSTTEpsilon', 'SpeechWordPronounceable',
    'SPEI_MIN_SR', 'SpeechEngineConfidence', 'SAFT32kHz8BitStereo',
    'DISPID_SpeechDataKey', 'SAFT8kHz16BitMono',
    'SpeechRecoContextState', 'SPAUDIOOPTIONS', 'DISPID_SVDisplayUI',
    'SPAR_Low', 'SRTExtendableParse', 'SAFTADPCM_44kHzMono',
    'SPEI_SR_BOOKMARK', 'SPSUnknown', 'DISPIDSPRG',
    'SpeechAddRemoveWord', 'SpMMAudioIn', 'ISpShortcut', 'SGRSTTRule',
    'SPSHT_NotOverriden', 'DISPID_SGRSTPropertyName',
    'SVEEndInputStream', 'ISpeechPhraseInfoBuilder', 'SPFILEMODE',
    'SpeechAllElements', 'SPPS_Unknown', 'SPPS_NotOverriden',
    'SpStream', 'SPEI_SENTENCE_BOUNDARY', 'SECFDefault',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SDKOpenKey', 'DISPID_SPPName',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPCT_COMMAND',
    'SPAR_High', 'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechRecognizerState', 'SPSTREAMFORMATTYPE',
    'DISPID_SRCEEnginePrivate', 'SRSEDone', 'DISPID_SABIBufferSize',
    'SGSEnabled', 'DISPID_SpeechLexicon', 'ISpXMLRecoResult',
    'DISPID_SLWWord', 'SRSActiveAlways', 'ISpeechWaveFormatEx',
    'DISPID_SPIEnginePrivateData', 'SpShortcut',
    'SAFT22kHz8BitStereo', 'SDTAudio', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPDKL_CurrentUser', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SRSNumberOfActiveRules', 'eLEXTYPE_RESERVED6',
    'DISPID_SRCVoicePurgeEvent', 'SPVPRIORITY',
    'DISPID_SVSLastBookmark', 'ISpeechGrammarRuleState',
    'SPAS_CLOSED', 'DISPID_SLPPhoneIds', 'DISPID_SOTsItem',
    'SPEI_RESERVED2', 'SVP_12', 'DISPID_SpeechVoiceStatus', 'SASStop',
    'eLEXTYPE_VENDORLEXICON', 'SVSFUnusedFlags',
    'DISPID_SMSAMMHandle', 'SPEI_REQUEST_UI', 'SVP_6', 'SPBO_NONE',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRCreateRecoContext', 'DISPID_SRGetPropertyNumber',
    'SECHighConfidence', 'SVEAllEvents', 'SRAExport', 'SRSActive',
    'DISPID_SPARecoResult', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SRGDictationLoad', 'SPEI_UNDEFINED',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpeechMemoryStream',
    'DISPID_SRProfile', 'DISPID_SRCCmdMaxAlternates',
    'SPINTERFERENCE_NOISE', 'DISPID_SRCState', 'SAFTGSM610_11kHzMono',
    'SPVPRI_ALERT', 'ISpRecognizer3', 'DISPID_SGRsItem',
    'SpeechLexiconType', 'DISPID_SVIsUISupported', 'SITooFast',
    'SVP_11', 'SREInterference', 'ISpeechAudioStatus',
    'DISPID_SGRSTType', 'WAVEFORMATEX', 'DISPID_SDKGetlongValue',
    'SpeechVoicePriority', 'DISPID_SRGCmdLoadFromResource',
    'ISpRecoGrammar', 'SVEAudioLevel', 'DISPID_SRCEFalseRecognition',
    'SRESoundStart', 'SPADAPTATIONRELEVANCE', 'DISPID_SPPId',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRIsUISupported', 'DISPID_SRCRequestedUIType',
    'SLOStatic', 'SVPAlert', 'DISPID_SPISaveToMemory',
    'SPEI_SR_PRIVATE', 'SP_VISEME_1', 'SPINTERFERENCE_TOOSLOW',
    'SVP_9', 'ISpeechPhraseInfo', 'DISPID_SpeechMemoryStream',
    'eLEXTYPE_PRIVATE15', 'SPXRO_Alternates_SML',
    'SRADefaultToActive', 'SAFTADPCM_44kHzStereo',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRRRecoContext',
    'DISPID_SRGRecoContext', 'DISPID_SPEAudioSizeTime',
    'Speech_Max_Word_Length', 'DISPID_SLPsCount',
    'SpeechPropertyComplexResponseSpeed', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRSSupportedLanguages', 'ISpeechRecoResultTimes',
    'SPTEXTSELECTIONINFO', 'SpMMAudioEnum', 'ISpeechRecoResult',
    'SVEBookmark', 'SAFTADPCM_8kHzMono', 'SPEI_WORD_BOUNDARY',
    'SpeechRecognitionType', 'SVSFDefault', 'DISPID_SAEventHandle',
    'DISPID_SPRulesCount', 'DISPID_SpeechPhraseRule',
    'DISPID_SRRSpeakAudio', 'DISPID_SPPParent',
    'SPEI_START_INPUT_STREAM', 'ISpDataKey', 'ISpeechPhraseElement',
    'SAFT24kHz8BitStereo', 'DISPID_SRGSetTextSelection',
    'DISPID_SRAudioInputStream', 'SPEI_RESERVED3', 'SpCustomStream',
    'SVP_13', 'SGLexicalNoSpecialChars', 'SLTApp', 'SPRS_INACTIVE',
    'ISpRecognizer2', 'ISpeechBaseStream', 'SVPOver', 'SVP_2',
    'SPWORDTYPE', 'SP_VISEME_20', 'SAFT8kHz16BitStereo',
    'ISpeechRecognizer', 'DISPID_SPEAudioStreamOffset',
    'SPINTERFERENCE_TOOLOUD', 'SPPS_Modifier', 'eLEXTYPE_PRIVATE2',
    'eLEXTYPE_PRIVATE11', 'DISPID_SRCEPhraseStart', 'DISPID_SRGReset',
    'DISPID_SLPs_NewEnum', 'DISPID_SDKSetLongValue',
    'DISPID_SOTs_NewEnum', 'SPINTERFERENCE', 'SPDKL_DefaultLocation',
    'SPEVENT', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechMicTraining', 'SP_VISEME_10', 'ISpeechDataKey',
    '_RemotableHandle', 'SREStreamStart',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SVSkip',
    'DISPID_SADefaultFormat', 'STCInprocServer',
    'DISPID_SPPs_NewEnum', 'SAFTADPCM_11kHzStereo', 'DISPID_SAStatus',
    'DISPID_SVEViseme', 'SpeechGrammarTagDictation',
    'ISpeechPhraseAlternate', 'SAFTADPCM_22kHzMono',
    'SECNormalConfidence', 'SAFT12kHz8BitStereo',
    'SVEStartInputStream', 'SWPUnknownWordPronounceable',
    'DISPID_SPIGetDisplayAttributes', 'SPPS_RESERVED3',
    'SGPronounciation', 'SPVPRI_NORMAL', 'DISPID_SPAs_NewEnum',
    'SpNotifyTranslator', 'DISPID_SPRuleChildren',
    'ISpeechAudioBufferInfo', 'eLEXTYPE_PRIVATE17', 'SRTSMLTimeout',
    'ISpPhoneticAlphabetSelection', 'SWTDeleted',
    'ISpeechPhraseAlternates', 'SP_VISEME_18', 'SDKLDefaultLocation',
    'SPRECORESULTTIMES', 'DISPID_SRCERequestUI',
    'ISpStreamFormatConverter', 'SPRECOSTATE', 'DISPID_SPRs_NewEnum',
    'SpFileStream', 'SpeechPropertyNormalConfidenceThreshold',
    'eLEXTYPE_PRIVATE1', 'SPCONTEXTSTATE', 'DISPID_SPEs_NewEnum',
    'SVP_3', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SPRuleId',
    'DISPID_SVWaitUntilDone', 'DISPID_SRSetPropertyNumber',
    'SpeechTokenKeyAttributes', 'SPRULE', 'DISPID_SpeechGrammarRule',
    'SFTInput', 'DISPID_SpeechAudioStatus',
    'SAFTCCITT_ALaw_44kHzMono', 'SPEI_SR_AUDIO_LEVEL',
    'ISpGrammarBuilder', 'DISPID_SASState', 'SPLEXICONTYPE',
    'ISpRecoContext', 'DISPID_SLWsCount', 'SRERequestUI',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SASFreeBufferSpace',
    'SGRSTTTextBuffer', 'SAFTNonStandardFormat',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SLPPartOfSpeech',
    'DISPID_SPIReplacements', 'DISPID_SRRAudio',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechLoadOption',
    'DISPID_SASetState', 'SPINTERFERENCE_NONE',
    'DISPID_SRCEAudioLevel', 'SSTTWildcard', 'SAFT32kHz8BitMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPSERIALIZEDRESULT', 'DISPID_SVEEnginePrivate',
    'DISPID_SPPsItem', 'DISPID_SGRSTsItem',
    'DISPID_SOTGetDescription', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SRRTLength', 'DISPID_SRStatus', 'DISPID_SASNonBlockingIO',
    'SREStreamEnd', 'SPRECOGNIZERSTATUS', 'SGSExclusive',
    'DISPID_SGRSAddSpecialTransition', 'SVP_0', '_ISpeechVoiceEvents',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SABIEventBias',
    'DISPID_SGRsAdd', 'SAFT12kHz16BitStereo',
    'SWPUnknownWordUnpronounceable', 'SPAUDIOSTATUS',
    'DISPID_SVEStreamEnd', 'SREHypothesis', 'eLEXTYPE_USER_SHORTCUT',
    'ISpNotifySink', 'DISPID_SVSRunningState', 'SVSFPersistXML',
    'DISPID_SRSAudioStatus', 'SPSMF_SAPI_PROPERTIES',
    'SPFM_OPEN_READONLY', 'SBONone', 'SRTEmulated',
    ...
    'DISPID_SpeechPhraseElements', 'SPPHRASEELEMENT', 'SPGS_ENABLED',
    'DISPID_SRCEStartStream', 'DISPID_SPIProperties',
    'SRSInactiveWithPurge', 'DISPID_SPRulesItem',
    'Speech_Max_Pron_Length', 'ISpEventSource',
    'DISPID_SVSInputWordLength', 'SDKLLocalMachine', 'SVP_1',
    'SAFT44kHz8BitStereo', 'SPEI_HYPOTHESIS', 'SpPhoneConverter',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFT44kHz16BitStereo',
    'DISPID_SPEAudioTimeOffset', 'SAFT11kHz16BitMono',
    'eLEXTYPE_PRIVATE12', 'SP_VISEME_14', 'DISPID_SOTCGetDataKey',
    'SAFT8kHz8BitStereo', 'SPEI_RECOGNITION', 'ISpeechRecoResult2',
    'DISPID_SDKCreateKey', 'UINT_PTR', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPPNumberOfElements', 'DISPID_SRCEAdaptation',
    'DISPID_SRGRules', 'SAFTADPCM_11kHzMono', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechPhraseReplacement', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SDKGetBinaryValue', 'DISPID_SLGetGenerationChange',
    'DISPID_SABIMinNotification', 'DISPID_SpeechRecoContext',
    'SGDSActiveWithAutoPause', 'SpeechCategoryVoices',
    'DISPID_SRCEEndStream', 'SFTSREngine', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPRNumberOfElements', 'DISPID_SPEActualConfidence',
    'DISPID_SWFEBlockAlign', 'DISPID_SPAsItem', 'IEnumSpObjectTokens',
    'SPAS_PAUSE', 'SpUnCompressedLexicon', 'SPWORD',
    'SAFT44kHz8BitMono', 'DISPID_SGRSAddWordTransition',
    'DISPID_SGRSTText', 'ISpVoice', 'SRTReSent',
    'DISPID_SREmulateRecognition', 'DISPID_SLRemovePronunciation',
    'DISPID_SLWs_NewEnum', 'SVSFParseSsml', 'DISPID_SLWLangId',
    'SPEI_PHONEME', 'SPAO_RETAIN_AUDIO', 'SPPHRASEPROPERTY',
    'SPBO_PAUSE', 'SPWT_DISPLAY', 'STCInprocHandler', 'SINoSignal',
    'SAFTCCITT_ALaw_22kHzMono', 'ISpeechXMLRecoResult',
    'DISPID_SBSWrite', 'DISPID_SRRSaveToMemory', 'DISPID_SVResume',
    'SpeechEmulationCompareFlags', 'DISPID_SpeechVoice',
    'tagSPPROPERTYINFO', 'ISpLexicon', 'SREPrivate',
    'DISPID_SOTCSetId', 'SpeechTokenIdUserLexicon',
    'SpeechVoiceEvents', 'SpeechDisplayAttributes', 'SGDisplay',
    'eLEXTYPE_PRIVATE18', 'SPLOADOPTIONS', 'ISpNotifyTranslator',
    'SVP_18', 'DISPID_SGRSTransitions', 'SPRST_ACTIVE', 'SPVPRI_OVER',
    'DISPID_SGRSTRule', 'SPPHRASEREPLACEMENT',
    'DISPID_SASCurrentDevicePosition', 'SREPropertyNumChange',
    'SpResourceManager', 'SPWT_LEXICAL', 'SAFTGSM610_22kHzMono',
    'DISPID_SOTIsUISupported', 'SPPHRASERULE', 'SREPhraseStart',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpeechWordType',
    'SAFTCCITT_uLaw_44kHzMono', 'SPSSuppressWord', 'SREAllEvents',
    'DISPIDSPTSI', 'DISPID_SRCESoundEnd', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRCERecognition', 'SpeechTokenKeyUI',
    'DISPID_SWFEBitsPerSample', 'SpObjectToken',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SpeechLexiconProns',
    'SPAUDIOSTATE', 'SGRSTTWildcard', 'ISpObjectWithToken',
    'DISPID_SPAPhraseInfo', 'SAFT24kHz16BitStereo', 'SPBINARYGRAMMAR',
    'SPDATAKEYLOCATION', 'SVP_16',
    'ISpeechGrammarRuleStateTransition', 'SDTPronunciation',
    'eLEXTYPE_PRIVATE5', 'SGSDisabled', 'SVP_10', 'SPCS_ENABLED',
    'ISpPhoneticAlphabetConverter', 'SP_VISEME_3',
    'DISPID_SPCIdToPhone', 'SPLO_DYNAMIC',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SDKGetStringValue',
    'SVSFIsXML', 'DISPID_SASCurrentSeekPosition',
    'SpeechPartOfSpeech', 'DISPID_SRCPause', 'SPSERIALIZEDPHRASE',
    'eWORDTYPE_DELETED', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpSharedRecognizer', 'DISPID_SVAlertBoundary',
    'DISPID_SLGetPronunciations', 'SPPS_Verb',
    'SpeechTokenValueCLSID', 'SPSEMANTICFORMAT',
    'DISPID_SAFSetWaveFormatEx',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRCERecognitionForOtherContext', 'SPPS_LMA',
    'DISPID_SGRs_NewEnum', 'SPEI_ADAPTATION', 'SPSLMA',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SABufferNotifySize',
    'SVSFNLPMask', 'SPEI_TTS_AUDIO_LEVEL',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SOTRemove',
    'DISPID_SPEDisplayText', 'SDTAlternates', 'DISPID_SPIElements',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPEsCount',
    'SpeechCategoryPhoneConverters', 'SREAdaptation',
    'DISPID_SRCCreateResultFromMemory', 'SPGS_DISABLED',
    'ISpeechPhraseProperty', 'DISPID_SpeechRecoContextEvents',
    'ISpObjectToken', 'SpeechDiscardType', 'SpeechGrammarState',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpeechRecoEvents',
    'DISPID_SWFEChannels', 'DISPID_SBSSeek', 'DISPID_SPRFirstElement',
    'DISPID_SRCRecognizer', 'DISPID_SGRInitialState',
    'DISPID_SLPLangId', 'DISPID_SGRSTPropertyValue', 'SITooQuiet',
    'DISPID_SGRAddState', 'SAFT48kHz8BitMono', 'SPSHT_OTHER',
    'SGDSActiveUserDelimited', 'SECFNoSpecialChars',
    'SAFT24kHz16BitMono', 'DISPID_SRGCmdLoadFromObject',
    'SpStreamFormatConverter', 'DISPID_SVEWord',
    'DISPID_SpeechWaveFormatEx', 'ISpeechLexiconWords',
    'DISPID_SOTGetAttribute', 'SP_VISEME_21', 'SVPNormal',
    'SpeechVoiceSkipTypeSentence', 'STCLocalServer',
    'DISPID_SPPConfidence', 'DISPID_SDKEnumValues',
    'DISPID_SRCResume', 'SAFT22kHz16BitMono', 'SpeechTokenKeyFiles',
    'ISpeechVoiceStatus', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SAVolume', 'SPCT_DICTATION',
    'DISPID_SLGenerationId', 'DISPID_SGRsCommit',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRGCmdSetRuleIdState',
    'SPWORDPRONOUNCEABLE', 'SPPS_SuppressWord', 'SVP_17',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRCSetAdaptationData',
    'SP_VISEME_8', 'SpeechRuleState', 'ISpeechPhoneConverter',
    'DISPID_SGRSTPropertyId', 'SINoise',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SVGetProfiles',
    'SRAORetainAudio', 'SVSFIsFilename', 'DISPID_SVVoice',
    'SPGRAMMARSTATE', 'SAFTTrueSpeech_8kHz1BitMono',
    'SpeechGrammarWordType', 'SP_VISEME_7', 'ISpPhoneConverter',
    'DISPID_SPIRule', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SVSLastResult', 'DISPID_SRRTTickCount',
    'DISPID_SGRAddResource', 'ISpSerializeState',
    'DISPIDSPTSI_SelectionOffset', 'SPXMLRESULTOPTIONS',
    'SP_VISEME_11', 'DISPID_SPIStartTime', 'SPLO_STATIC',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SRRTStreamTime',
    'DISPID_SRCRetainedAudio', 'SpeechVisemeType',
    'eLEXTYPE_PRIVATE13', 'SPSHORTCUTTYPE', 'SAFTText',
    'SpNullPhoneConverter', 'SPEI_START_SR_STREAM',
    'eLEXTYPE_PRIVATE7', 'SVSFVoiceMask', 'DISPID_SPRuleConfidence',
    'SVF_Emphasis', 'SPEI_MAX_SR', 'SGRSTTDictation',
    'SpeechVoiceSpeakFlags', 'SPEI_RECO_OTHER_CONTEXT', 'SPWORDLIST',
    'DISPID_SRCEPropertyNumberChange', 'SVSFParseMask',
    'SPGRAMMARWORDTYPE', 'SPPARTOFSPEECH', 'SPDKL_LocalMachine',
    'SpeechPropertyLowConfidenceThreshold', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SPIEngineId', 'DISPID_SRGetRecognizers', 'SVP_20',
    'SPRECOCONTEXTSTATUS', 'DISPID_SWFESamplesPerSec',
    'SPINTERFERENCE_NOSIGNAL', 'SPBO_TIME_UNITS',
    'SPEI_END_INPUT_STREAM', 'SECFEmulateResult', 'SPSNoun',
    'SpPhraseInfoBuilder', 'SVEVoiceChange', 'SASPause', 'SPAS_STOP',
    'eLEXTYPE_RESERVED7', 'DISPID_SVSInputWordPosition',
    'DISPID_SRCVoice', 'DISPID_SpeechAudioFormat',
    'SPAUDIOBUFFERINFO', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SPRuleNumberOfElements', 'SPBOOKMARKOPTIONS',
    'DISPID_SLPType', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechObjectTokenCategory', 'ISpeechFileStream',
    'SPEI_SOUND_END', 'DISPID_SGRSTsCount', 'SAFT22kHz8BitMono',
    'SpeechPropertyResponseSpeed', 'DISPID_SpeechPhraseProperties',
    'DISPID_SPIAudioSizeTime', 'SSSPTRelativeToStart',
    'SAFT11kHz8BitMono', 'ISpRecoResult', 'IInternetSecurityManager',
    'SpeechCategoryAppLexicons', 'SGRSTTWord', 'DISPID_SGRClear',
    'DISPID_SRGetPropertyString', 'DISPID_SGRsCount',
    'ISpeechRecoResultDispatch', 'DISPID_SRState', 'SpMemoryStream',
    'SpeechUserTraining', 'SVF_Stressed', 'DISPID_SPILanguageId',
    'SDTReplacement', 'ISpeechObjectTokenCategory', 'SPPS_Function',
    'SPCS_DISABLED', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRRTOffsetFromStart', 'SRATopLevel', 'SPRS_ACTIVE',
    'SPWORDPRONUNCIATION', 'SDTDisplayText',
    'DISPID_SRCERecognizerStateChange', 'SP_VISEME_6', 'SP_VISEME_9',
    'SSFMCreate', 'DISPID_SFSClose', 'DISPID_SLGetWords',
    'DISPID_SpeechPhraseInfo', 'DISPID_SpeechVoiceEvent',
    'DISPID_SPRuleEngineConfidence',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'eLEXTYPE_PRIVATE19',
    'SLODynamic', 'SSTTDictation', 'ISpeechRecoGrammar',
    'DISPID_SRAudioInput', 'SPBO_AHEAD',
    'SpeechGrammarTagUnlimitedDictation', 'SP_VISEME_19',
    'tagSTATSTG', 'SDA_Consume_Leading_Spaces', 'DISPID_SPRsCount',
    'ISpStream', 'eLEXTYPE_PRIVATE3', 'DISPID_SPIGetText',
    'SpeechStreamSeekPositionType', 'SPEI_SOUND_START',
    'DISPID_SGRAttributes', 'SPPS_Noun',
    'DISPID_SRGCmdLoadFromMemory', 'SAFT44kHz16BitMono',
    'SPRST_NUM_STATES', 'SpeechAudioFormatType',
    'SAFT11kHz8BitStereo', 'SPEI_INTERFERENCE',
    'DISPID_SPEDisplayAttributes', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SVP_21', 'ISpeechLexiconWord', 'SAFT24kHz8BitMono',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SLPSymbolic',
    'DISPID_SCSBaseStream', 'SpeechRecoProfileProperties',
    'DISPID_SMSGetData', 'SAFTCCITT_uLaw_11kHzStereo', 'SINone',
    'SP_VISEME_4', 'eLEXTYPE_APP', 'eLEXTYPE_RESERVED8',
    'DISPIDSPTSI_ActiveOffset', 'ISpRecognizer', 'SPFM_CREATE',
    'SVSFIsNotXML', 'SAFT12kHz8BitMono', 'SAFT12kHz16BitMono',
    'SRESoundEnd', 'ISpPhrase', 'SDA_No_Trailing_Space',
    'SAFTExtendedAudioFormat', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRRAudioFormat', 'DISPID_SPEPronunciation',
    'DISPID_SRGIsPronounceable', 'SPSHT_Unknown',
    'tagSPTEXTSELECTIONINFO', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SRSetPropertyString', 'eLEXTYPE_RESERVED10',
    'ISpStreamFormat', 'DISPID_SRSClsidEngine',
    'DISPID_SpeechGrammarRules', 'DISPID_SOTCreateInstance',
    'DISPID_SVGetAudioInputs', 'SpeechTokenContext', 'SVP_19',
    'SPVOICESTATUS', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SRADynamic', 'DISPID_SVSInputSentenceLength', 'ISpPhraseAlt',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRGId',
    'SREFalseRecognition', 'SVESentenceBoundary', 'SPPS_RESERVED1',
    'DISPID_SOTCDefault', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SPRuleFirstElement', 'SAFTCCITT_ALaw_11kHzMono',
    'SREStateChange', 'ISpeechLexiconPronunciation',
    'SAFT32kHz16BitMono'
]

_check_version('1.2.0', 1662606437.999286)
